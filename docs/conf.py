...
html_short_title = "Pandas TA Classic"
...
htmlhelp_basename = "pandas_ta_classicdoc"
...
man_pages = [
    (master_doc, "pandas_ta_classic", "pandas_ta_classic Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        master_doc,
        "pandas_ta_classic",
        "pandas_ta_classic Documentation",
        author,
        "pandas_ta_classic",
        "Technical Analysis Library in Python 3 using Pandas - Classic/Community Version",
        "Miscellaneous",
    ),
]
